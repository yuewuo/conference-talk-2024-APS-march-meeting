...
export default {
    ...
    async mounted() {
        ...
        this.mwpf_data_1 = await this.get_data('./common/aps2024_circuit_level_example_p0.0003.json')
        this.mwpf_data_2 = await this.get_data('./common/aps2024_circuit_level_example_p0.001.json')
        this.mwpf_data_3 = await this.get_data('./common/aps2024_circuit_level_example_p0.003.json')
        this.update_cameras()
